...
const Mentorship = () => {
  const mentors = [
    {id: 1, name: '', position: '', bio: '', facebook: '', instagram: '', linkedin: '', twitter: ''}
  ]
  const content = (
    <main>
          ...
          <div className='flex flex-col lg:flex-row'>
            ...
            <div className='grid gap-5 row-gap-5 sm:grid-cols-2'>
              <div className='max-w-md'>
                ...
                <h6 className='mb-2 font-semibold leading-5'>Video consultation</h6>
                <p className='text-sm text-gray-700'>
                  Support for individual assignments by critical and effective reading of academic texts, sourcing literature, identifying essay structure, content planning etc.
                </p>
              </div>
              <div className='max-w-md'>
                <div className='flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50'>
                ...
                <h6 className='mb-2 font-semibold leading-5'>Proofreading and editing</h6>
                <p className='text-sm text-gray-700'>
                  Get assignments proofread and edited, improving spelling and grammar. Includes additional consultation for feedback purposes.
                </p>
              </div>
              <div className='max-w-md'>
                <div className='flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50'>
                ...
                <h6 className='mb-2 font-semibold leading-5'>Career support services</h6>
                <p className='text-sm text-gray-700'>
                  Includes but not limited to Job application guidance, Linkedin set up and CV editing.
                </p>
              </div>
              <div className='max-w-md'>
                <div className='flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50'>
                ...
                <h6 className='mb-2 font-semibold leading-5'>Study skills development</h6>
                <p className='text-sm text-gray-700'>
                  This include effective time management, developing learning strategies, note-taking, biography and reference construction and presentation, academic writing style development among others.
                </p>
              </div>
              <div className='max-w-md'>
                <div className='flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50'>
                ...
                <h6 className='mb-2 font-semibold leading-5'>Presentation delivery preparation</h6>
                <p className='text-sm text-gray-700'>
                  Get a best-in-class help getting ready for your oral presentations and seminars.
                  With quick, actionable and memorable tips on making them a breeze.
                </p>
              </div>
              <div className='max-w-md'>
                <div className='flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50'>
                ...
                <h6 className='mb-2 font-semibold leading-5'>Revision | exam support</h6>
                <p className='text-sm text-gray-700'>
                  Get fantastic support in prepring for your tests and exams. Detailed that comes very close to getting you all the help you'll need for incredible scores.
                </p>
              </div>
              <div className='max-w-md'>
                <div className='flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50'>
                ...
                <h6 className='mb-2 font-semibold leading-5'>Free resources</h6>
                <p className='text-sm text-gray-700'>
                  Get free and unrestrained access to productivity notion templates, planners and courses.
                </p>
              </div>
              <div className='max-w-md'>
                <div className='flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50'>
                ...
                <h6 className='mb-2 font-semibold leading-5'>Unlimited email support</h6>
                <p className='text-sm text-gray-700'>
                  Get round-the-clock support via email from our mentors and at your convenience. While having effective response provided asap.
                </p>
              </div>
            </div>
          </div>
