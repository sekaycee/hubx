...
import { COURSES, LOCATIONS, POSITIONS } from '../config/positions'
    ...
    <main>
      ...
      <section id='positions'>
        <div className='px-8 mx-auto mt-24 py-24 lg:py-36 max-w-6xl border-t border-blue-100'>
                  ...
                  >
                    ...
                    <dd className='mt-2 text-sm text-gray-700 sm:col-span-4 sm:mt-0 sm:grid sm:grid-cols-4 sm:gap-4'>
                      ...
                      <div className='sm:col-span-1 place-self-end inline-flex my-auto'>
                        ...
                        <a onClick={() => openPosition(s)} className='ml-4 hover:text-blue-600 cursor-pointer'>•••</a>
                      </div>
                    </dd>
                  </div>
                ))}
          ...
          <ShowPosition position={position} open={positionOpen} close={closePosition} />

          <div className='text-center max-w-2xl mx-auto'>
            <p className='mt-7 mb-5 md:mt-10 md:mb-7 md text-sm text-gray-500'>
              Don't worry if you don't see any awards you want to apply for now. Register your interest to be notified of any awards that come along that meet your criteria. You can also add or reccommend a position for some hubx points or have our agents automatically process your selected award for a premium.
            </p>
            <div>
              <a
                href='/contact'
