        ...
        <div className='max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-24'>
          <div className='text-center'>
            ...
            <p className='mt-3 text-gray-600 dark:text-gray-400'>
              Stay in the know with insights from our world-renown experts.
            </p>
              ...
              <form>
                <div className='relative z-10 flex space-x-3 p-3 bg-white border rounded-lg shadow-lg shadow-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:shadow-gray-900/[.2]'>
                  <div className='flex-[1_0_0%]'>
                    <label for='hs-search-insight-1' className='block text-sm text-gray-700 font-medium dark:text-white'><span className='sr-only'>Search insight</span></label>
                    <input type='email' name='hs-search-insight-1' id='hs-search-insight-1' className='p-3 block w-full border-transparent rounded-md focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-800 dark:text-gray-400' placeholder='Search insight' />
                  </div>
                  <div className='flex-[0_0_auto]'>
                    <a className='p-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800' href='/blog/search'>
