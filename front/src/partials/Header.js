      ...
      <nav className='mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8' aria-label='Global'>
        ...
        <Popover.Group className='hidden lg:flex lg:gap-x-12'>
          <Popover className='relative'>
            ...
            >
              <Popover.Panel className='absolute -left-4 top-full z-50 mt-7 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5'>
                <div className='p-4'>
          ...
          <Popover className='relative'>
            ...
            <Transition
              ...
              leaveTo='opacity-0 translate-y-1'
            >
              <Popover.Panel className='absolute -left-36 top-full z-50 mt-7 w-screen max-w-md overflow-hidden rounded-3xl bg-white shadow-lg ring-1 ring-gray-900/5'>
                <div className='p-4'>
