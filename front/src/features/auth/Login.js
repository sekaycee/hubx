          ...
          <div className='mt-10 sm:mx-auto sm:w-full sm:max-w-sm'>
            <form className='space-y-6' action='/register' method='POST'>
              ...
              <div>
                <button
                  type='submit'
                  className={`${btn} bg-blue-600 px-3 font-semibold leading-6 text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600`}
                >
                  Sign in
                </button>
              </div>
              <div className='space-y-4 font-medium'>
                <button className={`${btn} gap-x-3 border hover:bg-gray-50 duration-150 active:bg-gray-100`}>
